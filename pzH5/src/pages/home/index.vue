...
onMounted(async () => {
  ...
  homeData.hospitals=[
    { id: 1, filename: 'c.jpeg', name: "武汉医院", rank: "三甲",label:'综合医院',intro:'武汉市中心医院是一家位于中国湖北省武汉市的大型综合性医院。' },
      { id: 2, filename: 'c.jpeg', name: "武汉医院", rank: "三甲",label:'综合医院',intro:'武汉市中心医院是一家位于中国湖北省武汉市的大型综合性医院。' },
        { id: 3, filename: 'c.jpeg', name: "武汉医院", rank: "三甲",label:'综合医院',intro:'武汉市中心医院是一家位于中国湖北省武汉市的大型综合性医院。' },
          { id: 4, filename: 'c.jpeg', name: "武汉医院", rank: "三甲",label:'综合医院',intro:'武汉市中心医院是一家位于中国湖北省武汉市的大型综合性医院。' },
            { id: 5, filename: 'c.jpeg', name: "武汉医院", rank: "三甲",label:'综合医院',intro:'武汉市中心医院是一家位于中国湖北省武汉市的大型综合性医院。' },
    // { id: 2, filename: 'hospital2.jpg', name: "医院B", rank: "二甲" }
  ]
  // homeData.hospitals =[
  //    { id: 1, filename: 'c.jpeg'},
  //    { id: 2, filename: 'c.jpeg'},
...
//     // item.pic_image_url.replace('https://', 'http://')
//         // 替换图片URL中的IP地址为域名
// // homeData.slides.forEach(item => {
// //     item.pic_image_url = item.pic_image_url.replace('http://', 'https://');
// });
// })
